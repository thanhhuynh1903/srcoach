...
import ScheduleFullCalendarScreen from '../screens/ScheduleScreens/ScheduleFullCalendarScreen';
...
export const stackScreens = [
  ...
  {name: 'ScheduleFullCalendarScreen', component: ScheduleFullCalendarScreen},
