...
const RecordDistanceScreen = () => {
  ...
  const prepareLineChartData = (records: any[]) => {
    ...
    if (activeView === 'day') {
      return sortedRecords.map((record, index) => ({
        ...
        label:
          index % 3 === 0 ? format(parseISO(record.startTime), 'HH:mm') : '',
  ...
  const calculateStats = (records: any[]) => {
    ...
    return {
      total: sum,
      average: Math.round((sum / values.length) * 10) / 10, // Keep one decimal
  ...
  const filteredRecords = filterRecordsByPeriod(
    distanceRecords,
    activeView,
    currentDate,
  );
      ...
      <View style={styles.viewToggleContainer}>
        <TouchableOpacity
          style={[
            ...
            activeView === 'day' && styles.activeToggle,
          ]}
          onPress={() => changeView('day')}>
          <Text
            style={[
              styles.viewToggleText,
              activeView === 'day' && styles.activeToggleText,
            ]}>
            Day
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[
            styles.viewToggleButton,
            activeView === 'week' && styles.activeToggle,
          ]}
          onPress={() => changeView('week')}>
          <Text
            style={[
              styles.viewToggleText,
              activeView === 'week' && styles.activeToggleText,
            ]}>
            Week
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[
            styles.viewToggleButton,
            activeView === 'month' && styles.activeToggle,
          ]}
          onPress={() => changeView('month')}>
          <Text
            style={[
              styles.viewToggleText,
              activeView === 'month' && styles.activeToggleText,
            ]}>
            Month
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[
            styles.viewToggleButton,
            activeView === 'year' && styles.activeToggle,
          ]}
          onPress={() => changeView('year')}>
          <Text
            style={[
              styles.viewToggleText,
              activeView === 'year' && styles.activeToggleText,
            ]}>
            Year
          </Text>
        </TouchableOpacity>
        ...
        <ScrollView style={styles.content}>
          ...
          <View style={styles.summaryContainer}>
            <View style={styles.summaryItem}>
              <View style={styles.distanceIconContainer}>
                <Icon name="locate" size={28} color="#10B981" />
              </View>
            ...
            <View style={styles.summaryItem}>
              ...
              <Text style={styles.summaryValue}>{dailyGoal} km</Text>
          ...
          <View style={styles.chartContainer}>
            <View style={styles.chartHeader}>
              ...
              <Text style={styles.chartDate}>{formatDate(currentDate)}</Text>
            </View>
            ...
            {lineData.length > 0 ? (
              <LineChart
                ...
                dataPointsRadius={4}
                startFillColor="rgba(16, 185, 129, 0.1)"
          ...
          <View style={styles.infoContainer}>
            ...
            <View style={styles.infoCard}>
              ...
              <Text style={styles.infoText}>
                ...
                increase your daily distance goal{'\n'}• Try interval walking
