          ...
          <View style={styles.profileSection}>
            <View style={styles.profileHeader}>
              <View style={styles.photoContainer}>
                <TouchableOpacity style={styles.photoWrapper} onPress={() => setAvatarModalVisible(true)}>
                  <Image
                    source={{
                ...
                <View style={styles.levelProgress}>
                  <View
                    style={[
                      styles.progressBar,
                      {
                        width: `${userData?.user?.points ? (userData.user.points / 500) * 100 : 0}%`,
                      },
                    ]}
                  />
                </View>
                <Text style={styles.levelText}>
                  <Text style={styles.pointsHighlight}>{userData?.user?.points || 0}</Text>/ 500 XP
                </Text>
              </View>
                  ...
                  >
                      ...
                      <View style={styles.postImageContainer}>
                        ...
                        {post.images.length > 1 && (
                          <View style={styles.remainingImagesIndicator}>
                            <Icon name="images-outline" size={14} color="#FFFFFF" style={styles.imageIcon} />
                            <Text style={styles.remainingImagesText}>+{post.images.length - 1}</Text>
                          </View>
                        )}
                      </View>
                    )}
                    {post.exercise_session_record_id && (
                      <View style={styles.runDataIndicator}>
                        ...
                        <Icon name="chevron-forward" size={20} color="#FFFFFF" style={{ marginLeft: 4 }} />
                      </View>
                    )}
                  </TouchableOpacity>
