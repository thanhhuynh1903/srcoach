...
import {getSessionMessages} from '../../../utils/useChatsAPI';
...
export default function ChatsSearchSessionMessagesScreen({
  messageId,
}: {
  messageId: string;
}) {
  ...
  const handleSearch = useCallback(async () => {
    ...
    try {
      const response = await getSessionMessages(sessionId, searchQuery);
      if (response.status) {
