...
const EnhancedScheduleCard = ({
  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.daysContainer}>
        {days.map((day) => (
          <TouchableOpacity
            ...
            style={[styles.dayCircle, selectedDay === day && styles.selectedDayCircle]}
          >
      ...
      {expanded && selectedDaySchedule && selectedDaySchedule.workouts.length > 0 && (
        <View style={styles.workoutDetailsContainer}>
          <Text style={styles.workoutDetailsTitle}>Workouts for Mar {selectedDay}, 2024</Text>
      ...
      <View style={styles.cardFooter}>
        <TouchableOpacity onPress={() => navigation.navigate("ScheduleDetailScreen" as never)}>
