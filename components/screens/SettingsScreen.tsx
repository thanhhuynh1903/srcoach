    ...
    <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.container}>
          ...
          <View style={styles.profileSection}>
            ...
            <View style={styles.progressContainer}>
              <View style={styles.progressBar}>
                <View style={[styles.progressFill, {width: `${profile?.points_percentage || 10}%`}]} />
              </View>
          ...
          <View style={styles.menuSection}>
            ...
            <TouchableOpacity
              ...
              <View style={styles.iconContainer}>
                <Icon name={isExpert ? "ribbon" : "ribbon-outline"} size={24} color={isExpert ? "#4CAF50" : "#FFA500"} />
              </View>
              <View style={styles.menuTextContainer}>
                <Text style={[styles.expertTitle, isExpert && styles.expertTitleActive]}>
                  {isExpert ? 'Expert Dashboard' : 'Become an Expert'}
                </Text>
                <Text style={[styles.expertSubtitle, isExpert && styles.expertSubtitleActive]}>
                  {isExpert ? 'View your expert status and certificates' : 'Requires legal documents for verification'}
                </Text>
              </View>
              {!isExpert && (
            ...
            <TouchableOpacity style={styles.logoutItem} onPress={() => setShowLogoutDialog(true)}>
              <View style={styles.iconContainer}>
      ...
      <CommonDialog
        ...
        content={
          <View>
            <Text style={{color: '#666', fontSize: 16}}>
              This process requires submission of legal documents for verification. 
...
const styles = StyleSheet.create({
  ...
  profileSection: {alignItems: 'center', marginBottom: 30, paddingBottom: 25, borderBottomWidth: 1, borderBottomColor: '#f0f0f0'},
  profileImage: {width: 100, height: 100, borderRadius: 50, marginBottom: 15, backgroundColor: '#e1e1e1', borderWidth: 3, borderColor: '#4A6FA5'},
  profileName: {fontSize: 24, fontWeight: 'bold', marginBottom: 5, color: '#333'},
  levelContainer: {flexDirection: 'row', alignItems: 'center', marginBottom: 15},
  levelText: {fontSize: 16, fontWeight: '600', color: '#4A6FA5', backgroundColor: '#EFF3F9', paddingHorizontal: 12, paddingVertical: 4, borderRadius: 12},
  expertBadge: {flexDirection: 'row', alignItems: 'center', backgroundColor: '#4CAF50', borderRadius: 12, paddingHorizontal: 8, paddingVertical: 4, marginLeft: 8},
  expertBadgeText: {color: 'white', fontSize: 11, fontWeight: 'bold', marginLeft: 4},
  progressContainer: {width: '100%', marginBottom: 20},
  progressBar: {height: 8, width: '100%', backgroundColor: '#E0E0E0', borderRadius: 4, overflow: 'hidden', marginBottom: 5},
  progressFill: {height: '100%', backgroundColor: '#4A6FA5', borderRadius: 4},
  progressTextContainer: {flexDirection: 'row', justifyContent: 'space-between', width: '100%'},
  progressText: {fontSize: 13, color: '#666', fontWeight: '500'},
  nextLevelText: {fontSize: 13, color: '#4A6FA5', fontWeight: '500'},
  statsGrid: {flexDirection: 'row', justifyContent: 'space-around', width: '100%', marginTop: 10},
  statItem: {alignItems: 'center', paddingHorizontal: 10},
  statNumber: {fontSize: 20, fontWeight: 'bold', color: '#4A6FA5', marginBottom: 2},
  ...
  expertItem: {flexDirection: 'row', alignItems: 'center', paddingVertical: 18, borderBottomWidth: 1, borderBottomColor: '#f0f0f0', backgroundColor: '#ffffff', marginVertical: 10, borderRadius: 8, paddingHorizontal: 0},
  ...
  expertTitle: {fontSize: 16, fontWeight: '700', color: '#FFA500', marginBottom: 3},
  ...
  logoutItem: {flexDirection: 'row', alignItems: 'center', paddingVertical: 18, marginTop: 10},
  logoutText: {fontSize: 16, color: '#E74C3C', fontWeight: '600', marginBottom: 3},
  legalBadge: {backgroundColor: '#FFA500', borderRadius: 4, paddingHorizontal: 6, paddingVertical: 2, marginRight: 10},
